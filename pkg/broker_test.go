...
func TestNewBroker(t *testing.T) {
	...
	assert.NotNil(t, b.rabbitMQ, "b.rabbitMq shouldn't be nil")

	assert.Nil(t, b.subscriber, "b.subscriber should be nil")
	assert.Nil(t, b.publisher, "b.publisher should be nil")
	assert.NotNil(t, b.Opts, "b.Opts shouldn't be nil")
}
